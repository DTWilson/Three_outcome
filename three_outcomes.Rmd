...
cons <- c(0.025, 0.2, 0, 0)
df2 <- data.frame(n=0:100)
df2 <- cbind(df2, t(sapply(df2$n, f, cons=cons, p0=p0, p1=p1, rules=rules)))
df2$v <- df2$V1 < 100
df2$V1 <- df2$V1 - 100*(!df2$v)
df2$c <- 0

ggplot(rbind(df, df2), aes(n, V1, colour=v, shape=as.factor(c))) + geom_point()
